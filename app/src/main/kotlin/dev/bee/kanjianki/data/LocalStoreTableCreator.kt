...
internal object LocalStoreTableCreator {
    ...
    fun createSimilarKanjiTables(db: SQLiteDatabase) {
        db.execSQL("${LocalStoreBase.SQL_CREATE_TABLE_IF_NEEDED}${LocalStoreBase.TABLE_SIMILAR_KANJI_PAIRS} (kanji_a TEXT NOT NULL, kanji_b TEXT NOT NULL, source TEXT NOT NULL, first_seen_at INTEGER NOT NULL, last_seen_at INTEGER NOT NULL, PRIMARY KEY (kanji_a, kanji_b, source))")
    ...
    fun createHistoricalSyncTables(db: SQLiteDatabase) {
        ...
        db.execSQL("${LocalStoreBase.SQL_CREATE_TABLE_IF_NEEDED}${LocalStoreBase.TABLE_SYNC_KANJI_SNAPSHOTS} (sync_id INTEGER NOT NULL, finished_at INTEGER NOT NULL, kanji TEXT NOT NULL, active_cards INTEGER NOT NULL, suspended_cards INTEGER NOT NULL, mature_support_count INTEGER NOT NULL, average_interval_days REAL NOT NULL, total_lapses INTEGER NOT NULL, total_reps INTEGER NOT NULL, fsrs_stability_avg REAL, fsrs_difficulty_avg REAL, fsrs_retrievability_avg REAL, weakness_score INTEGER NOT NULL, reason_code TEXT NOT NULL, active_example_count INTEGER NOT NULL, suspended_example_count INTEGER NOT NULL, PRIMARY KEY (sync_id, kanji))")
