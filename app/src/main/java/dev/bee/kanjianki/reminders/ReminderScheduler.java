...
public final class ReminderScheduler {
    ...
    static void showReminderNotification(Context context, ReminderServices services, AppClock clock) {
        ...
        ReminderCopyPolicy.ReminderCopy copy = reminderCopy(context, clock);
    ...
    private static ReminderCopyPolicy.ReminderCopy reminderCopy(Context context, AppClock clock) {
        try (LocalStore store = new LocalStore(context)) {
            ...
            return ReminderCopyPolicy.forPlan(AdaptiveLoadPlanner.PlanRequest.builder(
                            rows,
                            items,
