...
class StudyStatsStoreCoverageTest {
    @Test
    ...
    @Test
    fun ladderHealthSkipsNullRungKeysAndTreatsNullCountsAsZero() {
        val counts = LinkedHashMap<RecordsBase.LadderRung?, Int?>()
        counts[null] = 4
        counts[RecordsBase.LadderRung.WRITE_KANJI] = null
        counts[RecordsBase.LadderRung.TYPE_MEANING] = -3
        counts[RecordsBase.LadderRung.KANJI_MEANING] = 2

        val metric = StudyStatsStore.LadderHealthMetric(
            counts,
            1,
            21,
            3,
