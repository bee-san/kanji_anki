...
class StudyRepairActionsTest {
    ...
    fun activateSimilarWritingRepairStoresActiveTokenAndProgressKeys() {
        ...
        val active = StudyRepairActions.activateSimilarWritingRepair(repair, 1234L) { saved.set(it) }
    ...
    fun activateSimilarWritingRepairKeepsExistingActiveToken() {
        ...
        val active = StudyRepairActions.activateSimilarWritingRepair(repair, 1234L) { }
    ...
    private class RecordingFinisher(
        ...
        override fun finishSimilarWritingRepair(repairId: Long, activeToken: String?, passed: Boolean, nowMillis: Long): Boolean {
            events.add("finish")
