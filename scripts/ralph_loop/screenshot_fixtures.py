...
FIXTURES: tuple[ScreenshotFixture, ...] = (
    ScreenshotFixture(
        ...
        screenshot_names=("home-top.png", "home-middle.png", "home-bottom.png"),
    ...
    ScreenshotFixture(
        ...
        orientation="portrait",
        screenshot_names=("study-top.png", "study-middle.png", "study-bottom.png"),
    ...
    ScreenshotFixture(
        ...
        orientation="portrait",
        screenshot_names=("stats-top.png", "stats-middle.png", "stats-bottom.png"),
    ...
    ScreenshotFixture(
        ...
        orientation="portrait",
        screenshot_names=("settings-top.png", "settings-middle.png", "settings-bottom.png"),
    ...
    ScreenshotFixture(
        ...
        orientation="portrait",
        screenshot_names=("games-top.png", "games-middle.png", "games-bottom.png"),
    ...
    ScreenshotFixture(
        ...
        orientation="portrait",
        screenshot_names=("narrow-top.png", "narrow-middle.png", "narrow-bottom.png"),
        expected_terms=("Kani route home",),
        source_buckets=("home", "shell", "theme", "shared"),
    ...
    ScreenshotFixture(
        ...
        screenshot_names=("wide-top.png", "wide-middle.png", "wide-bottom.png"),
        expected_terms=("Kani route home",),
        source_buckets=("home", "shell", "theme", "shared"),
    ...
    ScreenshotFixture(
        ...
        orientation="portrait",
        screenshot_names=("update-top.png", "update-middle.png", "update-bottom.png"),
