...
/**
 * Counts the persisted study-item tasks that the focused Study route can serve.
 *
 ...
 * non-empty focus-scoped task keys the session selector can serve at
 * [studyAheadMillis], matching StudySessionTracker's plan initialization. App-owned
...
object StudyNowCountPolicy {
    ...
    private fun countSeeded(
        ...
        val allowedKanji = StudySessionFocusPolicy.allowedKanji(plan, false)
