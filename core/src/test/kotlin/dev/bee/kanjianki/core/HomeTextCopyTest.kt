...
class HomeTextCopyTest {
    ...
    fun browseStaticCopyAndFallbackMeaningStayCentralized() {
        ...
        assertEquals("1 of 2 selected for study", HomeTextCopy.browseStudySelectionSummary(1, 2))
        assertEquals("No kanji selected for study", HomeTextCopy.browseStudySelectionSummary(0, 0))
        assertEquals("Select all shown", HomeTextCopy.browseSelectAllStudiedLabel())
        assertEquals("Deselect all shown", HomeTextCopy.browseDeselectAllStudiedLabel())
