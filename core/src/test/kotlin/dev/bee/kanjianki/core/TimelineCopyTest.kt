...
class TimelineCopyTest {
    ...
    private fun timeline(
        ...
        RecordsStudyModels.KanjiRecoveryTimeline(row, item, Collections.emptyList<RecordsImportModels.KanjiTimelineEvent>())

    private fun studyItem(state: String, dueAtMillis: Long): RecordsStudyModels.StudyItem =
        RecordsStudyModels.StudyItem("x", state, dueAtMillis, 1.0, 5.0, 1, 0, 0, 1, null, 0L)
    ...
    private fun row(): RecordsImportModels.DashboardRow =
        RecordsImportModels.DashboardRow(
            ...
            0,
            1,
            Collections.emptyList<RecordsImportModels.KanjiTimelineEvent>(),
        )

    private fun event(expression: String, reading: String): RecordsImportModels.KanjiTimelineEvent =
        RecordsImportModels.KanjiTimelineEvent(
            1L,
            "x",
            10L,
            "sync",
