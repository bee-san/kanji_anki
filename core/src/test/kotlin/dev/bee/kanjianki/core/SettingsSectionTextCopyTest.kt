...
class SettingsSectionTextCopyTest {
    ...
    fun sectionLabelsPreserveFormatting() {
        ...
        assertEquals("Cards, timing, workload, ladder.", SettingsSectionTextCopy.settingsStudyBehaviorBody())
        assertEquals("Automation", SettingsSectionTextCopy.settingsAutomationTitle())
        assertEquals("Reminders, updates.", SettingsSectionTextCopy.settingsAutomationBody())
