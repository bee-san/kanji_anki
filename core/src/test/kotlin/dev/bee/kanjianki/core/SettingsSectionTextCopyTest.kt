...
class SettingsSectionTextCopyTest {
    ...
    fun sectionLabelsPreserveFormatting() {
        ...
        assertEquals("Note type, filters, and frequency range.", SettingsSectionTextCopy.settingsAnkiSourceBody())
        ...
        assertEquals("Grouped by Anki imports, study settings, automation, and reference data.", SettingsSectionTextCopy.settingsHeroBody())
