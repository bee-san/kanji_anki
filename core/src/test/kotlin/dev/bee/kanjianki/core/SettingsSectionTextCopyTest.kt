...
class SettingsSectionTextCopyTest {
    ...
    fun sectionLabelsPreserveFormatting() {
        ...
        assertEquals("Sources, filters, range, sync.", SettingsSectionTextCopy.settingsAnkiSourceBody())
    ...
    fun sectionLabelsTranslateToJapaneseLocale() {
        ...
        try {
            ...
            assertEquals("ソース、フィルター、範囲、同期。", SettingsSectionTextCopy.settingsAnkiSourceBody())
            ...
            assertEquals("辞書、ストローク、フォント、クレジット。", SettingsSectionTextCopy.settingsReferenceDataBody())
