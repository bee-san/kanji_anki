...
class SettingsSectionTextCopyTest {
    ...
    fun sectionLabelsPreserveFormatting() {
        ...
        assertEquals("Set reminders, sync, and updates.", SettingsSectionTextCopy.settingsAutomationBody())
    ...
    fun sectionLabelsTranslateToJapaneseLocale() {
        ...
        try {
            ...
            assertEquals("ソース、フィルター、範囲を選択。", SettingsSectionTextCopy.settingsAnkiSourceBody())
            ...
            assertEquals("リマインダー、同期、更新を設定。", SettingsSectionTextCopy.settingsAutomationBody())
