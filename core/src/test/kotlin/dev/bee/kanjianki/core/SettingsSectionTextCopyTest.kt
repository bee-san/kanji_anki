...
class SettingsSectionTextCopyTest {
    ...
    fun sectionLabelsPreserveFormatting() {
        ...
        assertEquals("Reminders and app updates.", SettingsSectionTextCopy.settingsAutomationBody())
    ...
    fun sectionLabelsTranslateToJapaneseLocale() {
        ...
        try {
            ...
            assertEquals("リマインダーとアプリ更新。", SettingsSectionTextCopy.settingsAutomationBody())
