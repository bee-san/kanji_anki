...
class SettingsSummaryTextCopyTest {
    ...
    fun summaryHelpersPreserveFormatting() {
        ...
        assertEquals("Pick import sources", SettingsSummaryTextCopy.settingsImportSummary(settings(false, false, false, false, false, 2)))
    ...
    fun summaryHelpersTranslateToJapaneseLocale() {
        ...
        try {
            ...
            assertEquals("インポート元を選ぶ", SettingsSummaryTextCopy.settingsImportSummary(settings(false, false, false, false, false, 2)))
