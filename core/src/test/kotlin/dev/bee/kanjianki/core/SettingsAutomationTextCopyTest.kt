...
class SettingsAutomationTextCopyTest {
    ...
    fun automationHelpersPreserveStatusCopy() {
        ...
        assertEquals("Android notifications are off; this reminder cannot appear.", SettingsAutomationTextCopy.notificationsBlockedBody())
        assertEquals("Open notification settings", SettingsAutomationTextCopy.openNotificationSettingsLabel())
        assertEquals("Allow notification permission before turning this on.", SettingsAutomationTextCopy.notificationPermissionBody())
