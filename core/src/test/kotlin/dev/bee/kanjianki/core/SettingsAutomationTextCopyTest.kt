...
class SettingsAutomationTextCopyTest {
    ...
    fun updateHelpersPreserveFormatting() {
        ...
        assertEquals("Installed: 0.4.33", SettingsAutomationTextCopy.installedVersionLine("v0.4.33"))
        assertEquals("Latest: 0.4.34", SettingsAutomationTextCopy.latestVersionLine("v0.4.34"))
        assertEquals("Latest: not checked yet", SettingsAutomationTextCopy.latestVersionLine("  "))
    ...
    fun automationHelpersTranslateToJapaneseLocale() {
        ...
        try {
            ...
            assertEquals("インストール済み: 0.4.33", SettingsAutomationTextCopy.installedVersionLine("v0.4.33"))
            assertEquals("最新: 0.4.34", SettingsAutomationTextCopy.latestVersionLine("v0.4.34"))
            assertEquals("最新: 未確認", SettingsAutomationTextCopy.latestVersionLine(null))
