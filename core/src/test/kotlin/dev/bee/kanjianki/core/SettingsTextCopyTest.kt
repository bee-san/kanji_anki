    ...
    fun settingsStatusSummariesPreserveAutomationCopy() {
        ...
        assertEquals(
                listOf(
                        ...
                        "Back to settings",
                        "Settings overview",
                        "Grouped by area: Anki import, study behavior, sync, reminders, updates, and reference data.",
                        "Anki note type",
                        "Import filters",
        ...
        assertEquals(
                ...
                listOf(
                        ...
                        SettingsTextCopy.categoryToggleDescription(false, "Sync, reminders, and updates"),
