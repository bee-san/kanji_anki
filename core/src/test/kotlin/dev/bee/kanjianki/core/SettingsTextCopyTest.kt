...
class SettingsTextCopyTest {
    ...
    fun settingsStatusSummariesPreserveAutomationCopy() {
        assertEquals(
                listOf(
                        ...
                        "Study settings",
                        "Cards, timing, workload, and ladder.",
                        "Automation",
    ...
    fun workloadSummariesPreserveSettingsCopy() {
        ...
        assertEquals(
                "Kani picks today's workload. Review due dates stay fixed.",
                SettingsTextCopy.automaticWorkloadBody()
        )
        ...
        assertEquals(
                "Set today's workload. Review due dates stay fixed.",
                SettingsTextCopy.manualWorkloadBody()
        )
        ...
        assertEquals(
                "Set how early due reviews appear. Learning delays still wait.",
                SettingsTextCopy.studyAheadBody()
        )
    ...
    fun studyAheadCopyPreservesLabelsAndValidationMessages() {
        assertEquals("Minutes early (0-1440)", SettingsTextCopy.studyAheadMinutesLabel())
