...
public final class SyncProgressCopyTest {
    @Test
    public void stageTitlesAndBodiesPreserveSyncProgressCopy() {
    ...
    @Test
    public void progressAndCardTextClampCounts() {
    ...
    @Test
    public void scanRateTextPreservesEtaCopy() {
        assertEquals(
        ...
        assertEquals("2.0 cards/sec - estimating time left", SyncProgressCopy.scanRateText(SyncProgressCopy.Stage.SCANNING_CARDS, 2, 20, 1000));
        assertEquals("5.0 cards/sec - about 3 sec left", SyncProgressCopy.scanRateText(SyncProgressCopy.Stage.SCANNING_CARDS, 5, 20, 1000));
        assertEquals("25 cards/sec - about 4 sec left", SyncProgressCopy.scanRateText(SyncProgressCopy.Stage.SCANNING_CARDS, 25, 125, 1000));
        assertEquals("10 cards/sec - finishing up", SyncProgressCopy.scanRateText(SyncProgressCopy.Stage.SCANNING_CARDS, 10, 10, 1000));
    }

    @Test
    public void shortDurationRoundsToCompactUnits() {
